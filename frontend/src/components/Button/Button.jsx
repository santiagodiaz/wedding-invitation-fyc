...
const Button = ( { buttonText, colorCode, url, action, disabled } ) => {
   ...
   const handleUrl = (url) => {
      const urlMapping = {
         calendar: 'https://calendar.google.com/calendar/u/0/r/eventedit?text=Casamiento+Caro+%26+Fausto+%F0%9F%92%8D&dates=20250208/20250209&details=Nos+casamos!%0A%0AA+tener+en+cuenta+%F0%9F%95%9C%F0%9F%91%87%F0%9F%8F%BC%0A%F0%9F%92%8D+La+ceremonia+comienza+a+las+13%3A00+hs.+en+Quinta+Aventura',
